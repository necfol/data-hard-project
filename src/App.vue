...
<style src="./assets/plugins/daterangepicker/daterangepicker-bs3.css"></style>
<style src="./assets/css/clndr.css"></style>
<style src="./assets/plugins/switchery/switchery.min.css"></style>
